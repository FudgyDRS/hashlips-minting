        ...
        {this.canMint() ? (
          <div className="mint-widget">
            <a
              ...
              target="_blank"
              href="https://etherscan.io/address/0xe707a98108C31C77dDee267fDe07EFC8A8Bf86cc"
            >
              Smart Contract:
              <br />
              0x74D134C1E6a8303b60D513AbcdBbCC6d52aD0147
            </a>
            <div className="preview">
              <img
                className="preview2"
                src="/build/images/gif.gif"
                alt="Collection preview"
              />
              <div className="pug-price">1 Peculiar Pug costs 0.1 ETH<br/>(Excluding gas fees)</div>
            </div>
