...
export default class Dapp extends React.Component<Props, State> {
  ...
  async mintTokens(amount: number): Promise<void> {
    try {
      console.log(
        'mint value: ',
        formatUnits(this.state.tokenPrice.mul(amount)),
      )
  ...
  private isContractReady(): boolean {
    console.log('this.contract after isContractReady: ', this.contract)
      ...
      <>
        ...
        {this.isWalletConnected() ? (
          <>
            ...
            {console.log('getSigner: ', this.provider.getSigner())}
  ...
  private async initWallet(): Promise<void> {
    ...
    } else if (network.chainId === CollectionConfig.fantomTestnet.chainId) {
      networkConfig = CollectionConfig.testnet
    } else {
    ...
    if (
      (await this.provider.getCode(CollectionConfig.contractAddress!)) ===
      '0xe707a98108C31C77dDee267fDe07EFC8A8Bf86cc'
    ) {
      this.setError(
